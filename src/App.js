...
export function createApp(target) {
  ...
  function renderHome() {
    ...
    badge.innerHTML = `<span class="badge badge--version" style="padding:var(--sp-1) var(--sp-3);font-size:var(--text-sm);font-weight:500;border-radius:var(--radius-full)">v1.1.0</span>`;
