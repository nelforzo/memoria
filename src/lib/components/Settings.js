      ...
      <div class="settings-section">
        ...
        <button class="btn btn--primary btn--disabled-gray" data-action="export" ${isExporting || collectionList.length === 0 ? 'disabled' : ''} style="padding:var(--sp-3) var(--sp-6)">
          ${isExporting
            ...
            : `<svg style="margin-right:var(--sp-2)" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/></svg>全コレクションをエクスポート`}
        </button>
      ...
      <div class="settings-section">
        ...
        <button class="btn btn--green btn--disabled-gray" data-action="import" ${isImporting ? 'disabled' : ''} style="padding:var(--sp-3) var(--sp-6)">
          ${isImporting
            ...
            : `<svg style="margin-right:var(--sp-2)" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"/></svg>ファイルからインポート`}
        </button>
